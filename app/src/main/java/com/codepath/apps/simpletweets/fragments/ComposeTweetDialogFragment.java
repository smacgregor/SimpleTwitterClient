 ...
 * {@link ComposeTweetDialogFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ComposeTweetDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ComposeTweetDialogFragment extends Fragment {

    @Bind(R.id.edit_tweet_body)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mCurrentUser = Parcels.unwrap(getArguments().getParcelable(CURRENT_USER));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_compose_tweet_dialog_fragmentment, container, false);
    }
